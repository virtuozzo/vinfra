from vinfra.api.compute.backup_plans import BackupPlanManager
...
from vinfra.api.compute.quotas import DomainQuotasManager, QuotasManager
...
from vinfra.api.compute.volume_backups import VolumeBackupManager
...
from vinfra.api.compute import ports
...
class Compute(object):
    ...
    def __init__(self, api):
        self.api = api
        self.backup_plans = BackupPlanManager(api, self)
        ...
        self.domain_quotas = DomainQuotasManager(api)
        ...
        self.volume_backups = VolumeBackupManager(api)
        ...
        self.ports = ports.PortManager(api)
